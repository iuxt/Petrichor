    ...
    static func write(phase: String) {
        ...
        payload["settings"] = [
            ...
            "appearance": [
                ...
                "desktopLyricsEnabled": defaults.boolOrNull("desktopLyricsEnabled"),
                "desktopLyricsClickThrough": defaults.boolOrNull("desktopLyricsClickThrough"),
                "desktopLyricsFontName": defaults.stringOrNull("desktopLyricsFontName"),
                "desktopLyricsFontSize": defaults.doubleOrNull("desktopLyricsFontSize")
            ],
            "library": [
